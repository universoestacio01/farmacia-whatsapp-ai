...
export const COMMERCIAL_MEDICINES: Record<string, CommercialMedicineConfig> = {
  ...
  nimesulida: {
    synonyms: ["nimesulida", "neosulida"],
    preferredBrands: ["NEOSULIDA", "NIMESULIDA"],
  ...
  torsilax: {
    synonyms: ["torsilax"],
    preferredBrands: ["TORSILAX"],
    preferredForms: ["COMPRIMIDO"],
    preferredDosages: [],
    defaultFormOrder: ["COMPRIMIDO"],
    preferredSmallPacks: [4, 10, 12, 20, 30],
    maxDefaultPackSize: 30,
  },
  neosoro: {
    synonyms: ["neosoro", "soro fisiologico nasal"],
    preferredBrands: ["NEOSORO"],
    preferredForms: ["SOLUCAO NASAL", "SPRAY"],
    preferredDosages: [],
    defaultFormOrder: ["SOLUCAO NASAL", "SPRAY"],
    preferredSmallPacks: [1],
    maxDefaultPackSize: 1,
  },
  cimegripe: {
    synonyms: ["cimegripe"],
    preferredBrands: ["CIMEGRIPE"],
    preferredForms: ["COMPRIMIDO", "CAPSULA", "GOTAS"],
    preferredDosages: [],
    defaultFormOrder: ["COMPRIMIDO", "CAPSULA", "GOTAS"],
    preferredSmallPacks: [4, 10, 12, 20],
    maxDefaultPackSize: 30,
  },
  buscopan: {
  ...
  engov: {
    synonyms: ["engov"],
    preferredBrands: ["ENGOV"],
    preferredForms: ["COMPRIMIDO"],
    preferredDosages: [],
    defaultFormOrder: ["COMPRIMIDO"],
    preferredSmallPacks: [4, 6, 10, 12],
    maxDefaultPackSize: 20,
  },
  luftal: {
    synonyms: ["luftal", "simeticona"],
    preferredBrands: ["LUFTAL", "SIMETICONA"],
    preferredForms: ["GOTAS", "COMPRIMIDO", "CAPSULA"],
    preferredDosages: [],
    defaultFormOrder: ["GOTAS", "COMPRIMIDO", "CAPSULA"],
    preferredSmallPacks: [1, 10, 20, 30],
    maxDefaultPackSize: 30,
  },
  neosaldina: {
    synonyms: ["neosaldina"],
    preferredBrands: ["NEOSALDINA"],
    preferredForms: ["DRAGEA", "COMPRIMIDO"],
    preferredDosages: [],
    defaultFormOrder: ["DRAGEA", "COMPRIMIDO"],
    preferredSmallPacks: [4, 10, 20, 30],
    maxDefaultPackSize: 30,
  },
  venvanse: {
    synonyms: ["venvanse", "lisdexanfetamina", "lisdexamfetamina"],
    preferredBrands: ["VENVANSE"],
    preferredForms: ["CAPSULA"],
    preferredDosages: ["30MG", "50MG", "70MG"],
    defaultFormOrder: ["CAPSULA"],
    preferredSmallPacks: [28, 30],
    maxDefaultPackSize: 30,
  },
};
