...
export class PopularManualMedicineService implements MedicineProvider {
  ...
  private readonly catalog: Record<string, NormalizedMedicineOption[]> = {
    ...
    neosoro: [
      this.option(
        "Neosoro",
        "Neosoro solução nasal 30ml",
        "solução nasal",
        "neosoro",
        9.9,
        "0,5mg/ml",
        "0,5 MG/ML SOL NAS CT FR GOT X 30 ML",
      ),
      this.option(
        "Neosoro H",
        "Neosoro H solução nasal 60ml",
        "solução nasal",
        "neosoro",
        12.9,
        "30mg/ml",
        "30 MG/ML SOL NAS CT FR X 60 ML",
      ),
      this.option(
        "Soro fisiológico nasal",
        "Soro fisiológico nasal 30ml",
        "solução nasal",
        "neosoro",
        8.9,
        undefined,
        "SOL NAS CT FR X 30 ML",
      ),
    ],
    torsilax: [
      this.option(
